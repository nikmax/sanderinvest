<?php
  ...
  if ($email == '') exit ('sorry, currently no registration possible');
  else exit('OK');
}
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="?create" class="row g-3 needs-validation" id="php-register-form" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourEmail2" class="form-label">Confirm Email</label>
                      <input type="email" name="email2" class="form-control" id="yourEmail2" required>
