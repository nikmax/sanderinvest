            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Your password will be reset</h5>
                    <p class="text-center small">The confirmation code has been sent to your email. Please enter the code from your email below</p>
                  </div>
